  ...
  const projects: Project[] = [
    {
      ...
      color: "from-teal-500 via-cyan-400 to-teal-500",
    ...
    },
    {
      ...
      technologies: ["JavaScript", "React", "Tailwind CSS", "Node.js", "Express.js", "MySQL", "Docker"],
      features: [
      ...
      teamSize: `6 ${isSpanish ? 'personas' : 'people'}`,
    ...
    },
    {
      id: 4,
      title: `TintasYa`,
      subtitle: `${isSpanish ? 'E-commerce de Tintas para Impresoras' : 'Printer Ink E-commerce'}`,
      description: `${isSpanish ? 'Tienda en línea especializada en tintas originales para impresoras Epson, HP y Canon con envíos a toda Colombia' : 'Online store specialized in original printer inks for Epson, HP and Canon with shipping throughout Colombia'}`,
      longDescription: `${isSpanish ? 'E-commerce moderno desarrollado con Next.js integrado con Shopify como backend, ofreciendo una experiencia de compra fluida y segura para tintas de impresora 100% originales. La plataforma permite a los clientes encontrar fácilmente las tintas compatibles con sus impresoras, realizar pagos seguros y recibir sus pedidos en 2-3 días hábiles en cualquier parte de Colombia.' : 'Modern e-commerce developed with Next.js integrated with Shopify as backend, offering a smooth and secure shopping experience for 100% original printer inks. The platform allows customers to easily find compatible inks for their printers, make secure payments and receive orders within 2-3 business days anywhere in Colombia.'}`,
      technologies: ["TypeScript", "Next.js", "Redux Toolkit", "Tailwind CSS", "Shopify"],
      features: [
        `${isSpanish ? 'Integración completa con Shopify para gestión de inventario, pedidos y pagos' : 'Complete Shopify integration for inventory, orders and payment management'}`,
        `${isSpanish ? 'Sistema de búsqueda y filtrado de productos por marca y modelo de impresora' : 'Product search and filtering system by printer brand and model'}`,
        `${isSpanish ? 'Diseño responsive y moderno optimizado para conversión de ventas' : 'Responsive and modern design optimized for sales conversion'}`,
        `${isSpanish ? 'Múltiples métodos de pago seguros y sistema de envíos a nivel nacional' : 'Multiple secure payment methods and nationwide shipping system'}`
      ],
      role: `${isSpanish ? 'Desarrollador Full Stack' : 'Full Stack Developer'}`,
      duration: `${isSpanish ? '1 semana' : '1 week'}`,
      teamSize: `1 ${isSpanish ? 'persona' : 'person'}`,
      impact: `${isSpanish ? 'Plataforma de ventas online que permite alcance nacional y automatización completa del proceso de venta' : 'Online sales platform enabling nationwide reach and complete sales process automation'}`,
      color: "from-cyan-500 via-blue-700 to-cyan-400",
      url: 'https://tintasya.com',
      images_urls: [
        '/assets/imgs/projects/main/tintasYa/Img1.webp'
      ],
      private: true
    },
    {
      ...
      color: "from-yellow-600 via-yellow-500 to-yellow-600",
    ...
    },
    {
      ...
      color: "from-purple-700 via-purple-400 to-purple-600",
